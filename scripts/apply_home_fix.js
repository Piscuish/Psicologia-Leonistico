...
console.log('=== FIXING HOME (INDEX.HTML & ASSETS) ===');

// 1. Copy original high-res logo to site_logo_official.png and ensure logo paths
const realLogoSrc = 'C:/Pagina WEB/uploads/site_logo_1788739866816.png';
if (fs.existsSync(realLogoSrc)) {
  fs.copyFileSync(realLogoSrc, 'C:/Pagina WEB/uploads/site_logo_official.png');
  fs.copyFileSync(realLogoSrc, 'C:/Pagina WEB/public/uploads/site_logo_official.png');
  fs.copyFileSync(realLogoSrc, 'C:/Pagina WEB/public/uploads/site_logo_1788739866816.png');
  console.log('✓ Replaced site_logo_official.png with original 1.16MB logo.');
}

// 2. Update data/db.json & public/data/db.json
...
db.homeContent = {
  ...
  aboutBadge: 'EQUIPO DE PSICO ORIENTACIÓN',
  aboutTitle: '¿Quiénes Somos?',
  aboutSubtitle: '',
  aboutParagraph1: 'Somos el equipo de Psicoorientación del Colegio Leonístico La Merced, comprometido con el acompañamiento de nuestros estudiantes en sus procesos emocionales dentro del contexto educativo. Brindamos orientación, estrategias y herramientas que contribuyen a su bienestar y favorecen su desarrollo integral, acompañándolos en las diferentes etapas de su proceso escolar.',
  aboutParagraph2: 'Asimismo, trabajamos de manera articulada con docentes y familias, brindando estrategias y orientaciones que les permitan fortalecer el acompañamiento de nuestros estudiantes y favorecer sus procesos emocionales, académicos y de adaptación escolar.',
...
console.log('✓ Updated data/db.json & public/data/db.json');

// 3. Build pristine index.html
    ...
    <div class="container nav-container">
      <a href="/" class="brand-logo">
        <div class="logo-img-wrapper">
          <img id="siteBrandLogo" src="/uploads/site_logo_1788739866816.png" alt="Logo Colegio Leonístico La Merced" class="logo-img">
        </div>
      ...
      <div class="container">
        <div class="content-image-grid reversed">
          <div class="section-text-block">
            <span class="sub-badge" id="homeAboutBadge">EQUIPO DE PSICO ORIENTACIÓN</span>
            <h2 id="homeAboutTitle">¿Quiénes Somos?</h2>
            <p id="homeAboutParagraph1" style="margin-bottom: 18px; color: #334155; font-size: 1.05rem; line-height: 1.75;">
              Somos el equipo de Psicoorientación del Colegio Leonístico La Merced, comprometido con el acompañamiento de nuestros estudiantes en sus procesos emocionales dentro del contexto educativo. Brindamos orientación, estrategias y herramientas que contribuyen a su bienestar y favorecen su desarrollo integral, acompañándolos en las diferentes etapas de su proceso escolar.
            </p>
            <p id="homeAboutParagraph2" style="color: #334155; font-size: 1.05rem; line-height: 1.75;">
      ...
      <div class="footer-grid">
        <div class="footer-brand">
          <div class="logo-img-wrapper" style="width: 44px; height: 44px;">
            <img id="footerBrandLogo" src="/uploads/site_logo_1788739866816.png" alt="Logo" class="logo-img">
          </div>
...
fs.writeFileSync('C:/Pagina WEB/index.html', indexHtml, 'utf8');
fs.writeFileSync('C:/Pagina WEB/public/index.html', indexHtml, 'utf8');
console.log('✓ Written index.html and public/index.html');

// 4. Update app.js and public/app.js to ensure renderHomeContent preserves exact DOM
function updateAppJsSafe(filePath) {
  let c = fs.readFileSync(filePath, 'utf8');

  // Replace renderHomeContent definition
  const renderHomePattern = /function renderHomeContent\(\) \{[\s\S]*?\n\}/m;
  ...
  c = c.replace(renderHomePattern, newRenderHome);

  // Replace applySiteImages definition
  const applySitePattern = /function applySiteImages\(\) \{[\s\S]*?\n\}/m;
  ...
  c = c.replace(applySitePattern, newApplySite);

  fs.writeFileSync(filePath, c, 'utf8');
  console.log('✓ Updated:', filePath);
}

updateAppJsSafe('C:/Pagina WEB/app.js');
updateAppJsSafe('C:/Pagina WEB/public/app.js');

console.log('=== ALL HOME FIXES APPLIED SUCCESSFULLY ===');
